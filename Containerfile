...
# generated from pdm.lock by scripts/konflux_requirements.sh.
COPY pyproject.toml README.md ${BUILD_DIR}/
COPY .konflux/ ${BUILD_DIR}/.konflux/
COPY src/ ${BUILD_DIR}/src/
COPY --chmod=0755 scripts/container-install.sh ${BUILD_DIR}/scripts/
